...
1. **Проверка через сервис**: Перейдите на сайт [https://federationtester.matrix.org](https://federationtester.matrix.org) и введите свой домен. Если сайт выдал результат **Success**, значит база настроена верно.
